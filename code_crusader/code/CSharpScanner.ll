...
This scanner reads a C# file and returns TextScanner::CSharp::Scanner::Tokens.
*/
...
%option namespace="TextScanner::CSharp" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in CSharpStyler
	...
	enum TokenType
	{
		...
		kError			// place holder for CSharpStyler
	};
