...
This scanner reads a bash file and returns TextScanner::BourneShell::Scanner::Tokens.
*/
...
%option namespace="TextScanner::BourneShell" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in BourneShellStyler
	...
	enum TokenType
	{
		...
		kComment,
		kError,			// place holder for BourneShellStyler
