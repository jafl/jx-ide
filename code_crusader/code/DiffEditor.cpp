...
DiffEditor::DiffEditor
	...
	:
	TextEditor(document, fileName, menuBar, lineInput, colInput, false,
				 scrollbarSet, enclosure, hSizing, vSizing, x,y, w,h)
{
	itsDiffDoc = (DiffDocument*) document;
}
