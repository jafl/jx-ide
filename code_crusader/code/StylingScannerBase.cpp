...
StylingScannerBase::StylingScannerBase
	(
...
StylingScannerBase::Token
StylingScannerBase::DocToken
	(
	const int type
	)
{
...
void
StylingScannerBase::SavePPNameRange()
{
...
JString
StylingScannerBase::GetPPCommand
	(
	const JString& text
	)
	const
...
bool
StylingScannerBase::SlurpQuoted
	(
	const JSize			count,
...
bool
StylingScannerBase::ReadCharacter
	(
