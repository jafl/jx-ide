...
This scanner reads a TCL file and returns TextScanner::TCL::Scanner::Tokens.
*/
...
%option namespace="TextScanner::TCL" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in TCLStyler
	...
	enum TokenType
	{
		...
		kOtherWord,
		kError			// place holder for TCLStyler
	};
...
void
TextScanner::TCL::Scanner::BeginScan
	(
