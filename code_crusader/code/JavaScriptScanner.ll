...
This scanner reads a JavaScript file and returns TextScanner::JavaScript::Scanner::Tokens.

Remember to upgrade HTMLScanner, too!
*/
...
%option namespace="TextScanner::JavaScript" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in JavaScriptStyler
...
void
TextScanner::JavaScript::Scanner::BeginScan
	(
