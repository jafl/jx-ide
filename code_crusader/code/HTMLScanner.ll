...
This scanner reads an HTML/XML/PHP/JSP file and returns TextScanner::HTML::Scanner::Tokens.
*/
...
%option namespace="TextScanner::HTML" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in HTMLStyler
	...
	enum TokenType
	{
		...
		kError			// place holder for HTMLStyler
	};
...
<<EOF>> {
	...
	/* remember to update JavaScanner */
...
<<EOF>> {
	...
	/* JavaScript -- copied from JavaScriptScannerL.l */

	/* Remember to upgrade JavaScriptScanner, too! */
...
void
TextScanner::HTML::Scanner::BeginScan
	(
...
{
	StylingScannerBase::BeginScan(text, startIndex, input);
...
TextScanner::HTML::Scanner::Token
TextScanner::HTML::Scanner::ScriptToken()
{
...
bool
TextScanner::HTML::Scanner::InTagState()
	const
{
