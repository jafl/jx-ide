...
This scanner reads a bash file and returns TextScanner::CShell::Scanner::Tokens.
*/
...
%option namespace="TextScanner::CShell" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in CShellStyler
