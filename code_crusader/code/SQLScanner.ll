...
This scanner reads a SQL file and returns TextScanner::SQL::Scanner::Tokens.
*/
...
public:
	...
	// these types are ordered to correspond to the type table in SQLStyler
	...
	enum TokenType
	{
		...
		kComment,
		kMySQLComment,
		kError			// place holder for SQLStyler
	};
}
