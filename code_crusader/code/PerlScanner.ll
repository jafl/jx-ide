...
This scanner reads a Perl file and returns TextScanner::Perl::Scanner::Tokens.
*/
...
%option namespace="TextScanner::Perl" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in PerlStyler
	...
	enum TokenType
	{
		...
		kError			// place holder for PerlStyler
	};
...
void
TextScanner::Perl::Scanner::BeginScan
	(
