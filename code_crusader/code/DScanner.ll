...
This scanner reads a D file and returns TextScanner::D::Scanner::Tokens.
*/
...
%option namespace="TextScanner::D" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in DStyler
	...
	enum TokenType
	{
		...
		kError,			// place holder for DStyler
