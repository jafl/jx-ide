...
This scanner reads a C/C++ file and returns TextScanner::C::Scanner::Tokens.
*/
...
%option namespace="TextScanner::C" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in CStyler
	...
	enum TokenType
	{
		...
		kTrigraph,
		kRespelling,
		kError,			// place holder for CStyler
