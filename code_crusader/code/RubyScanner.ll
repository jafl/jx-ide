...
This scanner reads a Ruby file and returns TextScanner::Ruby::Scanner::Tokens.
*/
...
%option namespace="TextScanner::Ruby" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in RubyStyler
	...
	enum TokenType
	{
		...
		kError			// place holder for RubyStyler
	};
...
void
TextScanner::Ruby::Scanner::BeginScan
	(
