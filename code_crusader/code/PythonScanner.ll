...
This scanner reads a Python file and returns TextScanner::Python::Scanner::Tokens.
*/
...
%option namespace="TextScanner::Python" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in PythonStyler
	...
	enum TokenType
	{
		...
		kError,			// place holder for PythonStyler
