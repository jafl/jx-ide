...
This scanner reads a Java file and returns TextScanner::Java::Scanner::Tokens.
...
%option namespace="TextScanner::Java" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in JavaStyler
