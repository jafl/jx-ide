...
This scanner reads a Go file and returns TextScanner::Go::Scanner::Tokens.
*/
...
%option namespace="TextScanner::Go" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in GoStyler
