...
This scanner reads a PHP .ini file and returns TextScanner::INI::Scanner::Tokens.
*/
...
%option namespace="TextScanner::INI" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in INIStyler
	...
	enum TokenType
	{
		...
		kError			// place holder for INIStyler
	};
}
