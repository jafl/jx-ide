...
This scanner reads an Eiffle file and returns EiffelScanner::Tokens.
*/
...
%option namespace="TextScanner::Eiffel" lexer="Scanner"
...
public:
	...
	// these types are ordered to correspond to the type table in EiffelStyler
	...
	enum TokenType
	{
		...
		kError			// place holder for EiffelStyler
	};
}
