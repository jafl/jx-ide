...
#include "lldb/DisplaySourceForMainCmd.h"
	...
	)
{
	...
	if (!found)
	{
		Link::NotifyUser(JGetString("CannotFindMain::LLDBDisplaySourceForMainCmd"), true);
		Link::Log("LLDBDisplaySourceForMainCmd failed to find 'main'");
